    ...
    <>
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 grid md:grid-cols-2 gap-10">
        <div className="flex flex-col justify-center">
          <h4 className="text-blue-500 font-bold uppercase py-5">
            Get in Touch
          </h4>
        ...
        <div className="bg-white shadow-xl rounded-xl p-8 flex flex-col justify-center">
          ...
          <p className="text-gray-600 text-sm mb-6">
            Your email address will not be published. Requiblue fields are
            marked <span className="text-blue-500">*</span>
          </p>
